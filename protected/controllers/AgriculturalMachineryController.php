...
class AgriculturalMachineryController extends Controller
{
	...
	const VEHICLE_TYPE_AGRICULTURAL_MACHINERY = 'agricultural machinery';
	...
	public function actionCreate()
	{
		...
		$vehicleTypeId                   = VehicleType::model()->findByAttributes(array('vehicle_type' => self::VEHICLE_TYPE_AGRICULTURAL_MACHINERY))->vehicle_typeid;
...
//		$this->performAjaxValidation(array($modelVehicle, $modelPhysicalPerson, $modelCompany, $modelVehicleAdvertisement));
	...
	{
		$ad                          = new VehicleAdvertisment('search');
		$ad->vehicle->vehicle_typeid = 5;
		$dataProvider                = $ad->search();
		var_dump($ad, $dataProvider);
	}
}

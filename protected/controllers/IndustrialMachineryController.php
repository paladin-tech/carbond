...
class IndustrialMachineryController extends Controller
{

	const VEHICLE_TYPE_INDUSTRIAL_MACHINERY = 'industrial machinery';
	...
	public function actionCreate()
	{
		...
		$vehicleTypeId                   = VehicleType::model()->findByAttributes(array('vehicle_type' => self::VEHICLE_TYPE_INDUSTRIAL_MACHINERY))->vehicle_typeid;

...
class MotorcycleController extends Controller
{
	...
	public function actionCreate()
	{
		...
		$vehicleTypeId                   = VehicleType::model()->findByAttributes(array('vehicle_type' => self::VEHICLE_TYPE_MOTORCYCLE))->vehicle_typeid;
...
//		$this->performAjaxValidation(array($modelVehicle, $modelPhysicalPerson, $modelCompany, $modelVehicleAdvertisement));
	...
	public function actionIndex()
	{
		...
		$criteria->addCondition('vehicle_typeid = 2');
		if(isset($_POST['yt0']))
		{
		...
		$this->render('index', array(
			'dataProvider' => $dataProvider, 'model' => $model, 'modelVehicle' => $modelVehicle, 'modelCar' => $modelCar,
		));

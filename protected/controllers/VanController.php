...
class VanController extends Controller
{
	...
	public function actionCreate()
	{
		...
		$vehicleTypeId                   = VehicleType::model()->findByAttributes(array('vehicle_type' => self::VEHICLE_TYPE_VAN))->vehicle_typeid;
			...
			if ($modelVehicle->validate()) {
				if ($modelVehicle->save(false)) {
					...
					foreach ($modelPhotoArray as $i => $photo) {
						...
						if ($fileName != '') {
							$photo->advertisement_id = $modelVehicleAdvertisement->vehicle_advertismentid;

...
class VehicleModelController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if (isset($_POST['VehicleModel'])) {
			...
			if ($model->save())
				$this->redirect(array('view', 'id' => $model->modelid));
		}
	...
	public function actionAdmin()
	{
		...
		if (isset($_GET['VehicleModel']))
			$model->attributes = $_GET['VehicleModel'];
	 ...
	 * @param VehicleModel $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if (isset($_POST['ajax']) && $_POST['ajax'] === 'vehicle-model-form') {

...
class ServiceType extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('service_type_name', 'required'),
			array('service_type_name', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('service_typeid, service_type_name', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'serviceAdvertisments' => array(self::HAS_MANY, 'ServiceAdvertisment', 'service_typeid'),
		);
	}

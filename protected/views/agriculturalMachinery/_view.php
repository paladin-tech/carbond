...
<div class="view">
	...
	<?php if (sizeof($data->photos) > 0) { ?>
	<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/vehicle/normal/vehicle-<?php echo $data->vehicleid ?>-<?php echo $data->photos[0]->file_name ?>">
	<?php } ?>
	<br/>

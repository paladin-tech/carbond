...
<?php
echo TbHtml::pageHeader('Boats', 'list view');
?>
...
<div style="float: left; width: 20%;">
	...
	echo TbHtml::dropDownList('fuel', '', CHtml::listData(Characteristic::model()->findAllByAttributes(array('vehicle_typeid' => array('0', '5'), 'characteristic_typeid' => '2')), 'characteristicid', 'characteristic_name'), array('empty' => ''));
...
<div style="float: left; width: 80%;">
	...
	{
		echo TbHtml::linkButton('New Boat', array(
			'color' => TbHtml::BUTTON_COLOR_PRIMARY,
			'size'  => TbHtml::BUTTON_SIZE_SMALL,
			'url'   => Yii::app()->createUrl('boat/create'))
		);
	}

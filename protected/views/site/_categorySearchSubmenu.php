<div class="sub-group clearfix">
	<div class="container">
		<div class="row">
			<ul>
				<li><a href="<?php echo $this->createUrl('vehicleAdvertisment/index', array('vehicleTypeId' => '1')); ?>" class="a">Automobili</a></li>
				<li><a href="<?php echo $this->createUrl('vehicleAdvertisment/index', array('vehicleTypeId' => '2')); ?>" class="b">Motori</a></li>
				<li><a href="<?php echo $this->createUrl('vehicleAdvertisment/index', array('vehicleTypeId' => '3')); ?>" class="d">Poljoprivredne mašine</a></li>

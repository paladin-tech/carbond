...
<?php
echo TbHtml::pageHeader('Vans', 'list view');
?>
...
<div style="float: left; width: 20%;">
	...
	echo TbHtml::dropDownList('year_from', '', Helper::getYearsArray(), array('span' => 1, 'empty' => ''));
	echo TbHtml::label('Year To', 'year_to');
	echo TbHtml::dropDownList('year_to', '', Helper::getYearsArray(), array('span' => 1, 'empty' => ''));
...
<div style="float: left; width: 80%;">
	...
	{
		echo TbHtml::linkButton('New Van', array(
			'color' => TbHtml::BUTTON_COLOR_PRIMARY,
			'size'  => TbHtml::BUTTON_SIZE_SMALL,
			'url'   => Yii::app()->createUrl('van/create'))
		);
	}

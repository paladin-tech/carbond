...
echo $form->dropDownListControlGroup($model, 'stearing_wheel_side', CHtml::listData(Characteristic::model()->findAllByAttributes(array('vehicle_typeid' => array(0, $vehicleTypeId), 'characteristic_typeid' => '16')), 'characteristicid', 'characteristic_name'), array('empty' => ''));

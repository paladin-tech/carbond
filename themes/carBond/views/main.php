...
<header>
	<div class="container">
		<div class="row">
			<div class="col-lg-2"><h1 id="logotipo"><a href="#"><?php echo CHtml::encode(Yii::app()->name); ?></a></h1>
			</div>
			<div class="col-lg-8 col-xs-12">
				<div id="banner">
					<img src="<?php print $basePath . '/images/banner_top.png'; ?>" class="img-responsive" width="100%" height="100%"/>
				</div>
				<?php $this->widget('zii.widgets.CMenu', array(
					...
					'items' => array(
						...
						array('label' => 'Servicing Data', 'url' => array('/servicer/addServicingData', 'vehicleTypeId' => 1), 'visible' => Yii::app()->user->getState('userRoles')['isVehicleDistributor']),						array('label' => 'Login', 'url' => array('/site/login'), 'itemOptions' => array('class' => 'last'), 'visible' => Yii::app()->user->isGuest),
...
<footer id="footer" class="clearfix">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-4"><p class="copyright">&copy; Carbond - All Rights Reserved - <?php echo date('Y'); ?>
					<br>T:381 11 26 70 750</p></div>

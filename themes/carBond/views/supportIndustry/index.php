<aside class="col-md-3">
	...
	<div class="group_info">
		<?php
		echo TbHtml::radioButtonListControlGroup('ServiceType', $selectedServiceType, CHtml::listData(ServiceType::model()->findAllByAttributes(array('is_tuning' => 0)), 'service_typeid', 'service_type_name'));
		?>
	</div>
